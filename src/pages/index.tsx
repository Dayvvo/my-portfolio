        ...
        <Box>
          <Grid templateColumns={'3px 96%'} columnGap={'0.8em'} gap={'1%'}>
            ...
            <Box fontSize={'19px'} lineHeight='35px'>
              <Box>
                Hello! 👋 I’m Matthew Adeyemi, a Software Engineer with more than 4 years of experience 
          ...
          <Center className=''>
            <Box mt='-1em'>
              ...
              <Center>
                <Box>
                  <Center>
                    <Text as='div' fontWeight={600} fontSize={'20px'} mt='1.4em' >I'm Matthew Adeyemi</Text>
                  </Center>
